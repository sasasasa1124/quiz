/**
 * Next.js App Router POST handler for creating GitHub issues.
 *
 * Usage in your app:
 *   // app/api/feedback/route.ts
 *   export { POST } from '@sasasasa1124/github-feedback/handler';
 *
 * Required env vars:
...
export async function POST(request: Request): Promise<Response> {
  ...
  // Upload images and collect markdown references
  ...
  for (const image of images) {
    ...
    if (url) {
      ...
      // Image upload failed — note it in the issue body
